...
delete from blumen2.pull_down_master where organizationid=:org_id;
...
--copy pulldownmaster  from org0 and project type
INSERT INTO blumen2.pull_down_master (deleted,inoriginal,is_numeric,lastmodify,lastuser,longpullna,organizationid,projtype,pullid,pullname,pulltype,timestamp_column)
 select deleted,inoriginal,is_numeric,current_timestamp,user,longpullna,:org_id,projtype,pullid,pullname,pulltype,current_timestamp  from blumen2.pull_down_master
 where organizationid=0 and projtype=:proj_type;
