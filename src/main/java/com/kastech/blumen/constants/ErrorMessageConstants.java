...
public class ErrorMessageConstants {
    public static final String PULL_DOWN_ALREADY_EXISTS_WITH_NUMBER = "A pulldown already exists for this number.";
    public static final String PULL_DOWN_ALREADY_DELETED_NUMBER = "The pulldown was deleted for this number.";
    public static final String INVALID_PULL_TYPE = "PULL TYPE IS INVALID";
    ...
    public static final String USER_INACTIVE = "User is not active";
    public static final String EMAIL_DUPLICATE = "Email is already in the system. Please provide different username";
    ...
    public static final String PASSWORD_EXPIRED = "User's password got expired";
