...
@Entity
@Table(name = "teacher" ,schema = "blumen2")
public class Teacher {

	@Id
	@GeneratedValue(strategy= GenerationType.AUTO, generator="teacher_seq_gen")
    @SequenceGenerator(name="teacher_seq_gen", sequenceName="TEACHER_SEQ")
	private Long id;
    ...
    public Teacher(String staffName, String staffId, String staffTitle, boolean staffActive, boolean staffTutor, String staffSSNO, String staffCounselor, String staffTeacher, String staffLab, String staffCodes, String staffDOB, String staffSpouseName, String staffHireDate, String staffDriverLicense, String staffTerminationDate, String staffCustomFieldOne, String staffCustomFieldTwo, String staffCustomFieldThree, String staffCustomFieldFour, String staffNotes, String staffPicture, Address address) {
