...
public class TeacherClassesController {
	...
	public ResponseEntity<Collection<TeacherContact>> getTeacherContactList() {
		...
		return ResponseEntity.ok(teacherClassesService.getTeacherContactList());
	}
	...
	public ResponseEntity<Collection<TeacherContact>> getCouncellorContactsByNormalFilter(
		...
		return ResponseEntity.ok(teacherClassesService.getTeacherContactsByNormalFilter( fiscalYear,
	...
	public ResponseEntity<Collection<TeacherContact>> getCouncellorContactsByAdvanceFilter(
		...
		return ResponseEntity.ok(teacherClassesService.getTeacherContactsByAdvanceFilter(contactDateFrom, contactDateTo,
	...
	public ResponseEntity<Collection<TeacherContact>> getCouncellorContactsByMoreFilter(
		...
		LOGGER.info("call received for getTeacherContactsByAdvanceFilter under StudentCouncellorContactController");
		return ResponseEntity.ok(teacherClassesService.getTeacherContactsByMoreFilter(collegeReady, advisor, codes, tutor,
	...
	public ResponseEntity<Collection<TeacherContact>> getCouncellorContactsByMoreAdvanceFilter(
		...
		return ResponseEntity.ok(teacherClassesService.getTeacherContactsByMoreAdvanceFilter(zipCode, major, siteLocation,
