...
public class ActivityGroupListController {
    ...
    @PreAuthorize("hasAnyAuthority('Activity / Services Group List_R','Activity / Services Group List_Y')")
    ...
    @PostMapping(path = "/activityGroupList/v1",
            ...
            produces = {MediaType.APPLICATION_JSON_VALUE})
    @PreAuthorize("hasAnyAuthority('Activity / Services Group List_Y')")
    ...
    public ActivityGroupList editActivityGroupList(@RequestBody ActivityGroupList activityGroupList) {
        ...
        activityGroupList.setModifiedBy(SecurityUtil.getUserId());
